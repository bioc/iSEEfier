...
```{r}
# this function creates the initial config for an iSEE instance to better explore your marker gene list
...
iSEEfier <- function(sce,
 ...
 # print(paste("Input clusters:", clusters))
  #print(paste("Input conditions:", conditions))
...
initial <- iSEEfier(sce = sce,feature.list = effector, clusters = my_clusters, conditions = my_conditions)
#for some reason i had to explicitly write feature.list = test and not only test, same for the rest of the param
# i also got rid of the panel.width param because it's giving me errors
